...
export async function buscarResumoEventoParaExclusao(
  eventoId: string,
...
export async function apagarEventoReprodutivo(localId: string, eventoId: string): Promise<ResultadoAcao> {
  const supabase = await criarClienteServidor();
